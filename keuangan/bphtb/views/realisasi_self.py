...
class BphtbViewSelf(BphtbView):
    def __init__(self, request):
        super(BphtbViewSelf, self).__init__(request)
        
    @view_config(route_name="bphtb-self", renderer="templates/self/list.pt",
                 permission="bphtb-self")
    def view_list(self):
    ...
    # Action #
    ##########
    @view_config(route_name='bphtb-self-act', renderer='json',
                 permission='bphtb-self-act')
    def view_act(self):
    ...
    # Posting #
    ###########
    @view_config(route_name='bphtb-self-post', renderer='json',
                 permission='bphtb-self-post')
...
def route_list(request):
    return HTTPFound(location=request.route_url('bphtb-self'))
...
# @view_config(route_name='bphtb-self-view', renderer='templates/self/add.pt',
             # permission='bphtb-self-view')
